...
def render_4_views(folder, origin = (0, 0, 0)):
    ...
    #     'right': (2.5, 0, 0.5),
    # }
# Camera 0: (2.5, 0.0, 0.5)
# Camera 1: (1.93, 1.93, 0.5)
# Camera 2: (0.0, 2.5, 0.5)
# Camera 3: (-1.93, 1.93, 0.5)
# Camera 4: (-2.5, 0.0, 0.5)
# Camera 5: (-1.93, -1.93, 0.5)
# Camera 6: (0.0, -2.5, 0.5)
# Camera 7: (1.93, -1.93, 0.5)
# Camera 8: (2.5, 0.0, 0.5)
